...
|------|-------------------|
| **Monero** | Core docs, getmonero.org, monero-docs, Windows operator paths |
| **Hermes / agents** | Multi-profile setups, Windows + Linux tooling, honest verification |
| **Systems** | Quiet fleet ops, privacy hygiene, scripts that stay boring and reliable |
...
| [hermes-windows-lab](https://github.com/monerostar/hermes-windows-lab) | Hermes learning docs + multi-profile stack map (Windows-first; multi-OS notes) |
...
- X: [@thewanderingtr1](https://x.com/thewanderingtr1)

Open to thoughtful collaboration on Monero ops tooling, privacy-respecting systems, and practical agent infrastructure (Windows + Linux).

---

*<sub>Profile README · keep it simple · no secrets</sub>*
